...
NotProcessedOutput = function(args) {
  ...
  cid3.5.2      = NA2LabelInFactor(args$n3.5.2$colony_id)#[args$n3.5.2$biological_sample_group %in% 'experimental']
  ...
  NotProcessedLogics = list(
    ...
    both_mut_and_control_after_preprocess = list(criteria_result = length(unique(bsg3.5.2)) > 1 ,
