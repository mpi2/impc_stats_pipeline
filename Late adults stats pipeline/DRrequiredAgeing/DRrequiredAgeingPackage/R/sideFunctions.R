...
StatsPipeline = function(path = getwd(),
  ...
  system('sbatch --time=01:00:00 --mem=1G -o ../compressed_logs/step2_job_id.txt --wrap="./jobs_step2_Parquet2Rdata.bch"', wait = TRUE)
  ...
  system('sbatch --time=01:00:00 --mem=1G -o ../compressed_logs/step4_job_id.txt --wrap="./jobs_step4_MergeRdatas.bch"', wait = TRUE)
  waitTillCommandFinish(
    WaitIfTheOutputContains = waitUntillSee,
    ignoreline = ignoreThisLineInWaitingCheck
  )
  ...
  system('sbatch --time=01:00:00 --mem=1G -o ../compressed_logs/phase2_job_id.txt --wrap="./DataGenerationJobList.bch"', wait = TRUE)
  waitTillCommandFinish(
    WaitIfTheOutputContains = waitUntillSee,
    ignoreline = ignoreThisLineInWaitingCheck
  )
  ...
  system('sbatch --time=05:00:00 --mem=1G -o ../compressed_logs/phase3_job_id.txt --wrap="./AllJobs.bch"', wait = TRUE)
  waitTillCommandFinish(
    WaitIfTheOutputContains = waitUntillSee,
    ignoreline = ignoreThisLineInWaitingCheck
  )
...
IMPC_statspipelinePostProcess = function(SP.results = getwd(),
  ...
  system('sbatch --time=03:00:00 --mem=1G -o ../../../../compressed_logs/extract_pval_job_id.txt --wrap="./ExtractPValJobs.bch"', wait = TRUE)
  DRrequiredAgeing:::waitTillCommandFinish(
    WaitIfTheOutputContains = waitUntillSee,
    ignoreline = ignoreThisLineInWaitingCheck
  )
  ...
  for (dir in c('category_of_type_categorical',
    ...
    job_to_submit <- paste(
      "sbatch --time=01:00:00 --mem=1G -o ../../../../../../compressed_logs/extract_pval_",
      dir,
...
IMPC_annotationPostProcess = function(SP.results = getwd(),
  ...
  system('sbatch --time=01:00:00 --mem=1G -o ../annotation_postprocess_job_id.txt --wrap="./jobs.bch"', wait = TRUE)
  DRrequiredAgeing:::waitTillCommandFinish(
    WaitIfTheOutputContains = waitUntillSee,
    ignoreline = ignoreThisLineInWaitingCheck
  )
...
IMPC_HadoopLoad = function(SP.results = getwd(),
  ...
  system('sbatch --time=03:00:00 --mem=1G -o ../../../../compressed_logs/hadoop_load_job_id.txt --wrap="./jobs.bch"', wait = TRUE)
  DRrequiredAgeing:::waitTillCommandFinish(
    WaitIfTheOutputContains = waitUntillSee,
    ignoreline = ignoreThisLineInWaitingCheck
  )
