...
# Further questions
This manual followed by the function manual in the **[OpenStats](https://github.com/mpi2/impc_stats_pipeline/tree/master/Late%20adults%20stats%20pipeline/OpenStats/OpenStatsPackage)** R package address the theories and implementation of the three statistical frameworks in OpenStats. The further questions could be requested by the email of the OpenStats developer, <hamedhm@ebi.ac.uk>.
